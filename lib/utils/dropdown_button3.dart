...
class CustomDropdownButtonState<T> extends State<CustomDropdownButton<T>> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
        ...
        child: Builder(
          builder: (context) {
            if (_selectedIndex != null) {
              return (widget.selectedItemBuilder ?? widget.itemBuilder)(context, widget.items[_selectedIndex!]).child;
            }
    ...
    if (widget.childBuilder != null) {
      return widget.childBuilder!(context, _selectedIndex != null ? widget.items[_selectedIndex!] : null, _handleTap);
    }
