...
mixin _$WeatherStore on _WeatherStore, Store {
  late final _$weatherInfoAtom =
      Atom(name: '_WeatherStore.weatherInfo', context: context);
  ...
  late final _$refetchWeatherAsyncAction =
      AsyncAction('_WeatherStore.refetchWeather', context: context);
